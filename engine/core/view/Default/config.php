...
<div align="center"><img src="<?php echo Engine::getHostURL(); ?>engine/core/view/Default/images/icon_settings.png" /></div>
<?php
...
<div align="center">
    ...
    <div class="loader" id="loader_config_save">
        <img src="<?php echo Engine::getHostURL(); ?>engine/core/view/Default/images/loader-1.gif" />
    </div>
    <div>
        <?php
